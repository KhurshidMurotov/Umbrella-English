...
export const a2Unit7Quiz = {
  ...
  questions: [
    ...
    { id: "a2u7q12", part: "Part 3", partTitle: "Past Simple", type: "part2-text-input", graded: true, points: 1, prompt: "My parents ____________ (not have) time to cook, so we didn't eat a healthy dinner.", correctAnswer: "didn't have", acceptedAnswers: ["didn't have", "didnt have", "did not have"], hint: "", options: [] },
    { id: "a2u7q13", part: "Part 3", partTitle: "Past Simple", type: "part2-text-input", graded: true, points: 1, prompt: "My parents didn't have time to cook, so we ____________ (not eat) a healthy dinner.", correctAnswer: "didn't eat", acceptedAnswers: ["didn't eat", "didnt eat", "did not eat"], hint: "", options: [] },
    { id: "a2u7q14", part: "Part 3", partTitle: "Past Simple", type: "part2-text-input", graded: true, points: 1, prompt: "My sister ____________ (not do) her homework because she didn't bring her books home.", correctAnswer: "didn't do", acceptedAnswers: ["didn't do", "didnt do", "did not do"], hint: "", options: [] },
    { id: "a2u7q15", part: "Part 3", partTitle: "Past Simple", type: "part2-text-input", graded: true, points: 1, prompt: "My sister didn't do her homework because she ____________ (not bring) her books home.", correctAnswer: "didn't bring", acceptedAnswers: ["didn't bring", "didnt bring", "did not bring"], hint: "", options: [] },
    { id: "a2u7q16", part: "Part 3", partTitle: "Past Simple", type: "part2-text-input", graded: true, points: 1, prompt: "Instead, we ____________ (make) a fire in the living room.", correctAnswer: "made", acceptedAnswers: ["made"], hint: "", options: [] },
    { id: "a2u7q17", part: "Part 3", partTitle: "Past Simple", type: "part2-text-input", graded: true, points: 1, prompt: "We ____________ (sit) on the sofa for hours.", correctAnswer: "sat", acceptedAnswers: ["sat"], hint: "", options: [] },
    { id: "a2u7q18", part: "Part 3", partTitle: "Past Simple", type: "part2-text-input", graded: true, points: 1, prompt: "It ____________ (be) very relaxing.", correctAnswer: "was", acceptedAnswers: ["was"], hint: "", options: [] },
    { id: "a2u7q19", part: "Part 3", partTitle: "Past Simple", type: "part2-text-input", graded: true, points: 1, prompt: "We ____________ (see) a documentary on TV.", correctAnswer: "saw", acceptedAnswers: ["saw"], hint: "", options: [] },
    { id: "a2u7q20", part: "Part 3", partTitle: "Past Simple", type: "part2-text-input", graded: true, points: 1, prompt: "We saw a documentary on TV and ____________ (eat) a large salad for a late snack.", correctAnswer: "ate", acceptedAnswers: ["ate"], hint: "", options: [] },
