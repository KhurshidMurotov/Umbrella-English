...
export const a2Unit7Quiz = {
  ...
  questions: [
    ...
    { id: "a2u7q16", part: "Part 3", partTitle: "Past Simple", type: "part2-text-input", graded: true, points: 1, prompt: "Instead, we ____________ (make) a fire in the living room.", correctAnswer: "made", acceptedAnswers: ["made"], hint: "Past simple of make is made.", options: [] },
    { id: "a2u7q17", part: "Part 3", partTitle: "Past Simple", type: "part2-text-input", graded: true, points: 1, prompt: "We ____________ (sit) on the sofa for hours.", correctAnswer: "sat", acceptedAnswers: ["sat"], hint: "Past simple of sit is sat.", options: [] },
    { id: "a2u7q18", part: "Part 3", partTitle: "Past Simple", type: "part2-text-input", graded: true, points: 1, prompt: "It ____________ (be) very relaxing.", correctAnswer: "was", acceptedAnswers: ["was"], hint: "Use was with it in the past simple.", options: [] },
    { id: "a2u7q19", part: "Part 3", partTitle: "Past Simple", type: "part2-text-input", graded: true, points: 1, prompt: "We ____________ (see) a documentary on TV.", correctAnswer: "saw", acceptedAnswers: ["saw"], hint: "Past simple of see is saw.", options: [] },
    { id: "a2u7q20", part: "Part 3", partTitle: "Past Simple", type: "part2-text-input", graded: true, points: 1, prompt: "We saw a documentary on TV and ____________ (eat) a large salad for a late snack.", correctAnswer: "ate", acceptedAnswers: ["ate"], hint: "Past simple of eat is ate.", options: [] },
